...
- [ ] talli: v3.5.5 build uploaded to ASC 2026-07-14 (archive/export/upload succeeded), processing. Ship-ios workflow publish/submit-for-review step errored on path issue (cosmetic, not build issue) — review submission needs manual confirmation/resuming.
