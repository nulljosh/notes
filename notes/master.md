...
**Latest (2026-07-15 Wednesday evening — Books project summary + Abraham HTTPS cert fix):** Books project summary wrap. Completed the Living Well in a Down Economy For Dummies book—organized and summarized tips #1-20 into the books repo (e595d81). Refreshed the README to list the top 5 summarized books at the top, moved all book summaries into their own collapsible section with a show/hide toggle to reduce visual clutter on the main rankings list, and added a Books badge to track progress on the portfolio. Synced the books site's design tokens to the portfolio's fredrika.dev theme (Geist sans + Instrument Serif serif headings, light/dark theme-aware palette). Checkpointed the remaining raw books in the roadmap for future processing: Becoming Steve Jobs, Brothers, Calculus for Dummies, PC for Dummies—all still in raw PDF/HEIC format, awaiting summary extraction. Site synced live to books.heyitsmejosh.com via Vercel auto-deploy (5 commits: e595d81, 2dbaae6, e821ef4, 1eff110, 05b2745). Roadmap updated with completed vs. pending items.
