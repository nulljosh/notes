...
**Latest (2026-07-14 Tuesday late evening — Echo landing page shipped + DNS repointed):** Echo marketing landing page built and deployed live. Added unusual-language badge to TranscriptionView.swift surfacing when WhisperKit detects a language outside the app's 11-language picker set (commit 4c8bbbb). Built new landing page at web/index.html styled after Lexly's design (Fraunces serif, DM Sans body, no monospace, fastlane screenshot carousel, comprehensive project description + CTA). Committed and pushed (421ccea + f2dd008, latter repointing image assets to GitHub raw URLs for live preview). Deployed to Vercel as project "echo-landing" at echo-landing-87j7zwabf-nulljosh-9577s-projects.vercel.app. Cloudflare DNS updated: echo.heyitsmejosh.com CNAME repointed from unused nulljosh.github.io placeholder to cname.vercel-dns.com for proper routing. Two blockers remain: (1) manual Vercel project settings step needed—domain not yet added in vercel.com/nulljosh-9577s-projects/echo-landing/settings/domains (blocks DNS resolution); (2) iOS ship blocked on stale App Store review submission (id 5d64a452-991e-4b8a-9187-a924674249d6) stuck in UNRESOLVED_ISSUES, must cancel via `asc review submissions-cancel --id 5d64a452-991e-4b8a-9187-a924674249d6 --confirm` before new build with bumped build number can ship. Journal updated + deployed via ./scripts/deploy.sh. Commit 7bf7839.
