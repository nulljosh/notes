...
All notes in one place. Updated 2026-07-14, evening.

**Latest (2026-07-14 Tuesday evening — SEO subcontracting engagement setup + cleanup across 9 repos):** Set up SEO subcontracting engagement docs for friend Abraham (non-git folder, ~/Library/Mobile Documents/com~apple~CloudDocs/Documents/Misc/Organize/abraham): wrote project CLAUDE.md, transcribed 3 reference YouTube videos into transcripts.pdf, combined negotiation screenshots into plan.pdf, rewrote/updated contract.pdf in plain language for cold-email-bot + SEO/Google-Business-Profile retainer scope, cleaned folder to PDFs only. Engagement docs ready for review. Also completed cleanup pass across 9 code repos with 35+ commits: BCGD reviews/brand retint, Books UI refresh with rankings collapse, Lexly lesson-completion hardening + architecture.svg, Dotfiles asc-aso-audit Phase 3, Echo xcodeproj + roadmap, NYC title-screen fix, Quotable theme-adaptive nav, Grapher whitepaper, Spark/Healstack roadmap updates, Talli v3.5.5 upload. 15 code repos + 1 client folder touched.
