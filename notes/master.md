...
All notes in one place. Updated 2026-07-07 (nightly wrap, Tuesday late evening).
...
| spark | v2.1.0 live, Mac build 1.0.0 uploaded to ASC (processing), auth consolidated (10/12 fns), dark-mode text fix. App Group linking fixed for all 4 App IDs (iOS, iOS Widgets, Mac, Mac Widgets) via developer.apple.com's App ID capability config (2026-07-07 late evening). Distribution profiles + signing ready, ready for archive/export/upload. | iOS screenshots + metadata + submit; archive/export/upload Spark iOS and Mac builds |
