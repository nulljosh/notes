...
All notes in one place. Updated 2026-07-07 (nightly wrap, Tuesday, Epiphany duplicate accounts fix + Markets features + Google OAuth login + Markets ticker perf fix).
