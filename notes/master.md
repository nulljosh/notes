...
- **GitHub cleanup:** quotable, wiretext, grapher, etyma, braingraph subtree-merged into labs monorepo (5 repos consolidated, commit history preserved). Push to origin + Vercel site repointing (grapher/wiretext/etyma) + old repo archiving pending tomorrow. Live sites (grapher.heyitsmejosh.com, wiretext.heyitsmejosh.com, etyma.heyitsmejosh.com) stay online throughout repoint.
